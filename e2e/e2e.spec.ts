...
test.serial('fixture spa', async (t) => {
...
test.serial('fixture vue ssr', async (t) => {
...
test.serial('fixture open-props', async (t) => {
...
test.serial('fixture tsconfig-paths', async (t) => {
...
test.serial('fixture path-alias', async (t) => {
...
test.serial('fixture remix', async (t) => {
...
test.serial('fixture qwik', async (t) => {
